...
export class Gridster {
    ...
    gridsterOptions: IGridsterOptions = {
        ...
        lanes: 80, // amount of lanes (cells) in the grid
    ...
    addWidgetFromDrag(gridster: GridsterComponent, event: any) {
        ...
        widget[Gridster.X_PROPERTY_MAP[breakpoint]] = item.x;
        widget[Gridster.Y_PROPERTY_MAP[breakpoint]] = item.y;
    ...
    addWidgets(gridster: GridsterComponent, widgets) {
    ...
    itemChange($event: any, gridster) {  //Override this method in the component where it is used.
