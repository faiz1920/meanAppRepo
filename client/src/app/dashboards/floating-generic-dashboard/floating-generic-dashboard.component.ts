...
@File Name : floating-generic-dashboard.component.ts
...
@Component({
  selector: 'app-floating-generic-dashboard',
  templateUrl: './floating-generic-dashboard.component.html',
  styleUrls: ['./floating-generic-dashboard.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class FloatingGenericDashboardComponent implements OnInit {
  ...
  addWidgetFromDrag(gridster: GridsterComponent, event: any) {
    ...
    widget[FloatingGenericDashboardComponent.X_PROPERTY_MAP[breakpoint]] = item.x;
    widget[FloatingGenericDashboardComponent.Y_PROPERTY_MAP[breakpoint]] = item.y;
